    ...
    this.muscleGroups = [
      {
        ...
        ordinal: 6,
        paths: [
          { id: 'chest1', data: 'M105.321,143.879 c-31.667,19.187-4.4,86.941,42.714,68.469C180.482,199.627,171.73,103.642,105.321,143.879z' },
          { id: 'chest2', data: 'M187.94,212.348 c47.115,18.472,74.381-49.283,42.714-68.469C164.246,103.642,155.494,199.627,187.94,212.348z' },
        ]
      }, {
        ...
        ordinal: 11,
        paths: [
          { id: 'hands1', data: 'M27.501,359.992 c-4.5,8.833-11.167,12.667-11,19.833s2.667,10.001,2.667,12.667s17.333-11.667,18.5-14.5S27.501,359.992,27.501,359.992z'},
          { id: 'hands2', data: 'M34.667,362.659c3.5,1.5,11,5.833,12.5,8.5 s4.333,8.333,3.5,14.833l-9.5-8.333L34.667,362.659z'},
          { id: 'hands3', data: 'M284.648,362.992c4.5,8.833,11.353,9.5,11,19.833 c-0.244,7.164-2.666,10-2.666,12.667s-20.502-11.141-20.981-14.167C270.02,368.825,284.648,362.992,284.648,362.992z'},
          { id: 'hands4', data: 'M271.501,363.992 c-3.284,1.928-10.513,7.666-11.667,10.5s-2.467,10.893-0.823,17.236l8.377-9.459L271.501,363.992z'},
          { id: 'hands5', data: 'M506.834,373.325 c-2.5,11.333-4.167,20.501-1,24.667s22.334-0.334,24.667-0.667s8.166-5.167,9.833-7s2.167-8.5-3-13.333s-7-7.833-7-7.833 L506.834,373.325z'},
        ]
      }, {
        ...
        ordinal: 18,
        paths: [
          { id: 'cardio', transform: 'rotate(225,150,121),translate(70,220)', opacity: 0.25, data: 'M0,50,v-50,h50,a25,25,22.5,0,1,0,50,a25,25,22.5,0,1,-50,0z'},
        ]
      }
    ]
